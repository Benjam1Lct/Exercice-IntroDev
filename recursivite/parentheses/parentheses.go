...
On peut, pour cela, construire les parenthésages parenthése par parenthése (on passera donc par des parenthésages qui ne sont
	pas bons, mais dont on est certains qu'on pourra les rendre bons plus tard),
	en faisant attention de ne pas ouvrir une parenthèse quand ce n'est pas possible
	(si on ne pourra jamais la fermer) et de ne pas fermer de parenthèses qui n'ont pas été ouvertes.

# Entrée
- n, la longueur des parenthésages souhaités

# Sorties
- sequences, l'ensemble des bon parenthésages de longueur n s'il en existe (une valeur quelconque sinon), sans doublons,
l'ordre des parenthésages dans le tableau n'a pas d'importance
